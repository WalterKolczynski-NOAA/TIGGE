...
%define configure_args  '--with-jasper=/usrx/local/prod/packages/gnu/4.8.5/jasper/1.900.29' '--with-openjpeg=/usrx/local/prod/packages/gnu/4.8.5/libpng/1.2.59/lib'
