  ...
  !> Create a new valid gribid from a GRIB sample.
  !> 
  !> GRIB sample files are stored in the directory pointed to
  !> by the environment variable GRIB_SAMPLES_PATH or in the default
  !> samples directory if this variable is not defined.
